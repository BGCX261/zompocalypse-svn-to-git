...
public:
	HelpScreen(Screen *previous) : previous(previous) {
		...
		thisHelp = new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, HELP0);
	...
	void displayNextHelpScreen()
	{
		...
		if (currentScreen == 0)
		{
			...
			thisHelp = new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, HELP1);
		...
		else if(currentScreen == 1)
		{
			...
			thisHelp = new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, HELP2);
		...
		else if(currentScreen == 2)
		{
			...
			thisHelp = new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, HELP3);
		...
		else if(currentScreen == 3)
		{
			...
			thisHelp = new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, HELP4);
