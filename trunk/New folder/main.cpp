...
public:
    MyMoblet()
    {
		...
		//gSkin = new WidgetSkin(RES_BG1, RES_BG1, 16, 32, 16, 32, true, true);
		gSkin = new WidgetSkin(RES_BG1, RES_BG1, 0, 48, 0, 48, true, true);
    ...
    //void runTimerEvent()
    //{
	//	if(mainScreen->currentScreen()==0 && !added)
	//	{
	//		PlayScreen *ob=mainScreen->screenObj();
	//		added=true;
	//		addTimer(ob, 50, -1);
	//	}
	//	else if(mainScreen->currentScreen()!=0)
	//	{
	//		PlayScreen *ob=mainScreen->screenObj();
	//		removeTimer(ob);
	//		added= false;
