...
public:
	ChangeBGScreen(Screen *previous) : previous(previous) {
		...
		new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, CHANGEBG1);
	...
	void displayNextBG()
	{
		...
		else if(currentScreen == 1)
		{
			...
			new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, CHANGEBG2);
	...
	void displayPreviousBG()
	{
		...
		else if(currentScreen == 1)
		{
			...
			new Image(0, 0, scrWidth, scrHeight-mainLayout->getChildren()[1]->getHeight(), layout, false, false, CHANGEBG0);
